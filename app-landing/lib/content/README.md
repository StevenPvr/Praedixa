...
- pour cet ICP QSR, le wording hero/homepage doit d'abord parler prevision de la demande, du stock et des besoins d'effectifs; le service, la marge ou le delivery viennent ensuite comme consequences metier, pas comme la promesse principale
