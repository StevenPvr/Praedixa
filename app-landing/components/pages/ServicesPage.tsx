...
export function ServicesPage({ locale, dict }: ServicesPageProps) {
  ...
  const localeCopy =
    locale === "fr"
      ? {
          serviceKicker: "Niveaux de service",
          methodKicker: "Methodologie de choix",
          comparisonFallback: "Comparatif indisponible pour le moment.",
          criterionLabel: "Critere",
          signatureLabel: "Service Signature",
          forecastingLabel: "Forecasting-only",
          includesFallback: "Aucun element renseigne pour le moment.",
          limitsFallback: "Aucune limite renseignee pour le moment.",
          decisionFallback: "Guide de decision indisponible pour le moment.",
        }
      : {
          serviceKicker: "Service levels",
          methodKicker: "Selection method",
          comparisonFallback: "Comparison is currently unavailable.",
          criterionLabel: "Criterion",
          signatureLabel: "Signature Service",
          forecastingLabel: "Forecasting-only",
