...
- page services/offre: `ServicesPage.tsx`
- page preuve publique: `DecisionProofPage.tsx`
...
- les copies produit canonique viennent de `lib/content/value-prop/*`
...
- le parcours public doit rester coherent avec l'entree `preuve sur historique -> cadrage d'un premier perimetre`; eviter de reintroduire une offre publique parallele via un ancien `pilote ROI`, une route `/deploiement` vivante ou un vieux `protocole`
