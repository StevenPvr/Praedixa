  ...
  return (
    <SectionShell id="how-it-works" className="section-dark">
      <motion.div
        ...
        transition={SPRING}
      >
        <Kicker className="text-brass-300">{dict.howItWorks.kicker}</Kicker>
          ...
          {dict.howItWorks.steps.map((step, i) => (
            ...
            >
              <div className="flex items-start justify-center">
                <span className="relative z-10 flex h-14 w-14 items-center justify-center rounded-full border border-brass-400/40 bg-brass-800 text-base font-bold text-brass-300">
                  {step.number}
                </span>
              </div>
              <div className="pb-2">
                <span className="text-xs font-semibold uppercase tracking-[0.08em] text-brass-300">
                  {step.subtitle}
                </span>
