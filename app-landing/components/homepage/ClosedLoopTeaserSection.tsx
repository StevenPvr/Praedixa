...
const copy = {
  fr: {
    ...
    heading: "Du risque détecté à l'action priorisée.",
    sub: "Praedixa fédère les signaux utiles, anticipe les écarts business à court terme, calcule les arbitrages coût / service / risque, prépare la première action validée et relit l'impact obtenu.",
    ctaLabel: "Voir la méthode Praedixa",
    footer:
      "Le but n'est pas d'ajouter une couche de plus. Le but est d'aider les équipes réseau à décider plus tôt sur les écarts qui coûtent cher, puis à relire ce qui a vraiment marché.",
    sideEyebrow: "Méthode Praedixa",
    sideTitle:
      "Une boucle courte pour corriger les risques avant qu'ils ne dégradent la performance.",
    sideBody:
      "On commence par voir quels écarts menacent l'activité. Ensuite on compare les options, on valide la première action dans vos outils et on suit l'impact réel.",
    steps: [
      {
        number: "01",
        label: "Fédérer",
        sub: "Les signaux utiles sur l'existant",
        accent: "Effectifs · demande · stocks",
        icon: Circuitry,
      },
      {
        number: "02",
        label: "Prédire",
        sub: "Les écarts business à court horizon",
        accent: "J+3 · J+7 · J+14",
        icon: Binoculars,
      },
      {
        number: "03",
        label: "Calculer",
        sub: "Les arbitrages coût / service / risque",
        accent: "Scénarios comparés",
        icon: ChartLineUp,
      },
      {
        number: "04",
        label: "Déclencher",
        sub: "La première action validée par vos équipes",
      ...
      },
      {
        number: "05",
        label: "Prouver",
        sub: "L'impact réel et les gains observés",
        accent: "Résultat relu",
        icon: TrendUp,
      },
    ],
  },
  en: {
    kicker: "How it works",
    heading: "From detected risk to prioritized action.",
    sub: "Praedixa federates the useful signals, anticipates short-horizon business gaps, calculates cost / service / risk trade-offs, prepares the validated first action, and reviews the impact achieved.",
    ctaLabel: "See the Praedixa method",
    footer:
      "The point is not to add another layer. The point is to help network teams decide earlier on the gaps that cost money, then review what actually worked.",
    sideEyebrow: "Praedixa method",
    sideTitle: "A short loop to correct risks before they degrade performance.",
    sideBody:
      "It starts by showing which gaps threaten the business. Then it compares options, validates the first action in your tools, and tracks the real impact.",
    steps: [
      {
        number: "01",
        label: "Federate",
        sub: "Useful signals on top of the stack",
        accent: "Staffing · demand · inventory",
        icon: Circuitry,
      },
      {
        number: "02",
        label: "Predict",
        sub: "Short-horizon business gaps",
        accent: "D+3 · D+7 · D+14",
        icon: Binoculars,
      },
      {
      ...
      },
      {
        number: "04",
        label: "Trigger",
        sub: "First action validated by your teams",
      ...
      },
      {
        number: "05",
        label: "Prove",
        sub: "Real impact and observed gains",
        accent: "Result reviewed",
        icon: TrendUp,
      },
    ],
  },
