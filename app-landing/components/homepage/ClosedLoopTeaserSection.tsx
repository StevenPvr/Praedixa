    ...
    steps: [
      {
        number: "01",
        label: "Fédérer",
        sub: "Les systèmes critiques sur l'existant",
        accent: "RH · finance · opérations",
        icon: Circuitry,
      },
      {
        number: "02",
        label: "Prédire",
        sub: "Les besoins et écarts à court horizon",
        accent: "J+3 · J+7 · J+14",
        icon: Binoculars,
      },
      {
      ...
      },
      {
        number: "04",
        label: "Déclencher",
        sub: "La première action validée",
      ...
      },
      {
        number: "05",
        label: "Prouver",
        sub: "Le ROI décision par décision",
