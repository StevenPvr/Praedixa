  ...
  return (
    <motion.a
      ...
      className={cn(
        ...
        variant === "primary" &&
          "border-oxide bg-oxide text-ink shadow-diffusion shadow-[0_20px_36px_-18px_rgba(246,180,76,0.45)]",
        variant === "secondary" &&
          "border-white/18 bg-white/10 text-limestone shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] backdrop-blur-sm",
        className,
      )}
