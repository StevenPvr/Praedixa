...
export function WhyNowSection() {
  const { whyNow } = greekiaMessaging;

  return (
    <section id="why-now" className="section-shell bg-limestone/80">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {whyNow.benefits.map((benefit, index) => (
              <motion.article
                ...
                className="rounded-[1.8rem] border border-white/10 bg-ink p-5 text-limestone shadow-diffusion"
              >
