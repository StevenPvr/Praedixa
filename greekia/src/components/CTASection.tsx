...
export function CTASection() {
  const { cta } = greekiaMessaging;

  return (
    <section id="cta" className="section-shell pt-12">
      <div className="section-inner">
        <div className="grid gap-6 rounded-[2.8rem] border border-white/10 bg-ink px-6 py-8 text-limestone shadow-diffusion sm:px-8 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
