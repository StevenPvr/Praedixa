...
CAMUNDA_HOME="$ROOT_DIR/.tools/camunda"
...
usage() {
  cat <<'EOF'
Usage:
  ./scripts/camunda-dev.sh download [--full]
  ./scripts/camunda-dev.sh up [--full]
  ./scripts/camunda-dev.sh down [--full] [--volumes]
  ./scripts/camunda-dev.sh status [--full]
  ./scripts/camunda-dev.sh logs [--full]
