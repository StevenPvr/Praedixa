...
export KEYCLOAK_SMTP_FROM KEYCLOAK_SMTP_FROM_DISPLAY_NAME KEYCLOAK_SMTP_REPLY_TO KEYCLOAK_SMTP_REPLY_TO_DISPLAY_NAME KEYCLOAK_SMTP_HOST KEYCLOAK_SMTP_PORT KEYCLOAK_SMTP_USER KEYCLOAK_SMTP_PASSWORD KEYCLOAK_SMTP_AUTH KEYCLOAK_SMTP_STARTTLS KEYCLOAK_SMTP_SSL
