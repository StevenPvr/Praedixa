...
BUILD_SOURCE="marketing/presentations-clients/greekia"
...
echo "Deploying greekia to namespace ${NAMESPACE_NAME} (${NS_ID})"
...
echo "Deployment command submitted for greekia."
