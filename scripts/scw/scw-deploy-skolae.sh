...
BUILD_SOURCE="marketing/presentations-clients/skolae"
...
echo "Deploying skolae to namespace ${NAMESPACE_NAME} (${NS_ID})"
...
echo "Deployment command submitted for skolae."
