...
Le projet est range sous `marketing/presentations-clients/greekia/` dans le monorepo.
...
- `../tests/greekia/`: smoke tests de contenu mutualises au niveau `marketing/presentations-clients/tests/`.
