...
export function DecisionFocusSection() {
  const { decisionFocus } = greekiaMessaging;

  return (
    <section
      id="decision-focus"
      className="section-shell bg-gradient-to-b from-transparent to-white/45"
    >
        ...
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          >
            ...
            <div className="mt-8 grid gap-4">
              {decisionFocus.frame.map((item, index) => {
                const Icon = frameIcons[index] ?? Lightning;
                return (
                  <div
                    key={item.label}
          ...
          >
            <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-oxide">
              Actions que Greekia peut comparer
            </p>
