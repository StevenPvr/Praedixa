...
- Les bodies non `GET`/`HEAD` sont bornes par `API_PROXY_MAX_BODY_BYTES` avec une limite par defaut a `1 MiB`; un depassement renvoie `413 payload_too_large` avant l'appel upstream.
