...
vi.mock("@/lib/api/endpoints", () => ({
  ADMIN_ENDPOINTS: {
    orgCanonical: (orgId: string) => `/api/v1/admin/organizations/${orgId}/canonical`,
    orgCanonicalQuality: (orgId: string) => `/api/v1/admin/organizations/${orgId}/canonical/quality`,
  },
}));
