...
def _to_response(req: ErasureRequest) -> ErasureRequestResponse:  # pragma: no cover
...
async def initiate_erasure_endpoint(  # pragma: no cover
...
async def approve_erasure_endpoint(  # pragma: no cover
...
async def execute_erasure_endpoint(  # pragma: no cover
    request_id: uuid.UUID,
...
async def verify_erasure_endpoint(  # pragma: no cover
    request_id: uuid.UUID,
    session: AsyncSession = Depends(get_db_session),
    _current_user: JWTPayload = Depends(require_role("super_admin")),
...
async def get_erasure_request_endpoint(  # pragma: no cover
    request_id: uuid.UUID,
    _current_user: JWTPayload = Depends(require_role("super_admin")),
) -> ApiResponse[ErasureRequestResponse]:
