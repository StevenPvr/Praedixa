...
async def test_validate_option_422_index_exceeds_available(
    ...
    short_result = ArbitrageResult(
        ...
        options=[
            ArbitrageOption(
                type="overtime", label="OT", cost=100, delay_days=0,
                coverage_impact_pct=10, risk_level="low", risk_details="ok",
                pros=["a"], cons=["b"], score=0.5,
            ),
            ArbitrageOption(
                type="no_action", label="NA", cost=0, delay_days=0,
                coverage_impact_pct=0, risk_level="high", risk_details="bad",
                pros=["c"], cons=["d"], score=0.1,
            ),
        ],
