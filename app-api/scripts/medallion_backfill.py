"""Backfill a requested date window through the standard medallion pipeline."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Backfill a medallion date window.")
    parser.add_argument(
...
def main() -> None:
    ...
    if start_date is None or end_date is None:
        msg = "start-date and end-date must be valid ISO dates"
