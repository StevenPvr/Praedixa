...
class DailyForecast(TenantMixin, Base):
    ...
    capacity_planned_current: Mapped[float] = mapped_column(
        Numeric(10, 2), nullable=False
    )
    capacity_planned_predicted: Mapped[float] = mapped_column(
        Numeric(10, 2), nullable=False
    )
    capacity_optimal_predicted: Mapped[float] = mapped_column(
        Numeric(10, 2), nullable=False
    )
