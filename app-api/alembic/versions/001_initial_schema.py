...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "size",
            sa.Enum("small", "medium", "large", "enterprise", name="organizationsize"),
        ),
    ...
    op.create_table(
        ...
        sa.Column("headcount", sa.Integer, server_default="0"),
        sa.Column("min_staffing_level", sa.Numeric(5, 2), server_default="80.0"),
    ...
    op.create_table(
        ...
        sa.Column("is_critical_role", sa.Boolean, server_default=sa.text("false")),
    ...
    op.create_table(
        ...
        sa.Column(
            "category",
            sa.Enum("planned", "unplanned", "statutory", name="absencecategory"),
            nullable=False,
        ),
        ...
        sa.Column(
            "end_portion",
            sa.Enum(
                "full", "morning", "afternoon", name="dayportion", create_type=False
            ),
            server_default="full",
        ),
        sa.Column(
    ...
    op.create_index("ix_absences_organization_id", "absences", ["organization_id"])
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("low", "medium", "high", "critical", name="decisionpriority"),
            nullable=False,
        ),
        sa.Column(
            "status",
    ...
    op.create_index("ix_decisions_department_id", "decisions", ["department_id"])
