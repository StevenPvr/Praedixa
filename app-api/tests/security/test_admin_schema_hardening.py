...
class TestEmailValidation:
    ...
    def test_org_create_rejects_free_email_provider(self) -> None:
        """Free inbox providers are rejected for enterprise onboarding."""
...
class TestSlugValidation:
    ...
    def test_org_create_rejects_reserved_prefix_slug(self) -> None:
        """Reserved DB prefixes are rejected after schema pattern validation."""
        with pytest.raises(ValidationError):
            AdminOrgCreate(
                name="Test",
                slug="pg_admin",
    ...
    def test_onboarding_create_rejects_reserved_prefix_slug(self) -> None:
        """Onboarding slug uses the same DDL-safe validator."""
        with pytest.raises(ValidationError):
            AdminOnboardingCreate(
                org_name="Test",
                org_slug="pg_admin",
