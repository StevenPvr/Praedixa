...
class TestGetPlatformKPIs:
    ...
    async def test_returns_all_metrics(self) -> None:
        ...
        assert result["api_error_rate"] == 1.0
...
class TestGetErrorMetrics:
    ...
    async def test_returns_metrics(self) -> None:
        ...
        assert result["api_error_rate"] == 4.0
    ...
    async def test_rounding(self) -> None:
        ...
        assert result["api_error_rate"] == 33.33
