...
| CTRL-SDLC-01  | Code scanning and hard gates in local signed gate | Signed local gate reports + tool logs + gate scripts/config      | CTO         | Continuous                 | CC7.x              | A.8                    |
...
| CTRL-RISK-01  | Residual risk acceptance governance               | `13-residual-risk-acceptance-log.md`                             | CTO         | Weekly                     | CC3/CC7            | A.5                    |
| CTRL-THRT-01  | Threat intelligence and CVE triage                | `14-threat-intel-and-cve-log.md`                                 | Security    | Daily/Weekly               | CC7.x              | A.5, A.8               |
| CTRL-ABUSE-01 | Abuse-case review for sensitive workflows         | `15-abuse-case-review-template.md`                               | Product/Sec | Per release                | CC7/CC8            | A.8                    |
| CTRL-SC-01    | Supply-chain integrity checks                     | `docs/runbooks/supply-chain-integrity-verification.md`           | CTO/DevOps  | Per release                | CC7/CC9            | A.8                    |
