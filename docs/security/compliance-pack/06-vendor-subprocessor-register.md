...
| Supabase (if active) | Auth/identity             | User identity/session metadata                                    | Region to verify        | To complete |                 62 | High       | Quarterly        | [DATE]      | 2026-03-15  | CTO   | Not approved for production until France residency and DPA are validated.                     |
