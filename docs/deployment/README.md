...
- Le merge vers `main` doit etre protege par `Autorite - Required` et au moins une review obligatoire; les hooks locaux restent un preflight, pas l'autorite finale.
