...
| `API-ENV`  | `ENVIRONMENT`, `DEBUG=false`, `LOG_LEVEL`, `KEY_PROVIDER=scaleway`, `AUTH_JWKS_URL`, `AUTH_ISSUER_URL`, `AUTH_AUDIENCE`, `AUTH_ALLOWED_JWKS_HOSTS`, `CORS_ORIGINS`, `KEYCLOAK_ADMIN_USERNAME`, `SCW_DEFAULT_PROJECT_ID`                                                                                                                                                                                                                                                                                                                                  |
| `API-SEC`  | `DATABASE_URL`, `RATE_LIMIT_STORAGE_URI`, `CONTACT_API_INGEST_TOKEN`, `RESEND_WEBHOOK_SECRET`, `KEYCLOAK_ADMIN_PASSWORD`, `SCW_SECRET_KEY`                                                                                                                                                                                                                                                                                                                                                                                                               |
